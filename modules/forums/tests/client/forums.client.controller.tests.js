  ...
  describe('Forums Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ForumsService) {
        ...
        expect($state.go).toHaveBeenCalledWith('forums.view', {
          forumId: mockForum._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      ...
      it('should set $scope.vm.error if error', inject(function (ForumsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Forum and redirect to Forums', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('forums.list');
      });
